 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Category whereCompanyId($value)
...
{
    use TenantModels, Sluggable;
    // use TenantModels, Sluggable, Filterable;
